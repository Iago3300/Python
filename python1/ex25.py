def break_words(stuff):
    """Esa função irá dividir palavras para nós"""
    words = stuff.split(' ')
    return words
...
def print_first_word(words):
    """Imprime a primeira palavra depois de tirar-la do conjunto"""
    word = words.pop(0)
    print(word)
...
def print_first_and_last_sorted(sentence):
    """Ordena as palavras e então imprime a primeira e a ultuma"""
